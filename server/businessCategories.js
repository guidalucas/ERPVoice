export const BUSINESS_CATEGORIES = [
  {
    ...
    promptExamples: [
      ...
      '"una camiseta de River titular 2026 talle S versión jugador vale 65 mil, la de Independiente también" -> add_stock x2 (listado de ingreso, NO update_product). price 65000, size S, productModel incluye "versión jugador"',
      '"carga todo lo que te mencioné" (contexto: listado de camisetas) -> add_stock por cada ítem del contexto',
      '"Juan me pidió una camiseta de Boca titular talle M" -> client_order con size "M"',
      '"la camiseta de boca titular vale 70000" -> update_product con price SOLO si es un cambio de precio suelto, no un listado de ingreso',
